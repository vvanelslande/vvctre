...
if (url.searchParams.has('code')) {
  fetch(
    'https://https-vvanelslande.github.io-vvctre-plugin-maker-code-and-builds-user-github-account-api.vvanelslande.dynv6.net:32851/github-code-to-access-token',
    {
      headers: {
