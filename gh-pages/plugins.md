...
- [vvctre-pm13api](https://github.com/vvanelslande/vvctre-pm13api)
  - [GUI client]({{ site.baseurl }}/plugin-maker/code-and-builds-no-account/) (it uses my server)
...
[Download Windows 7z](https://github.com/vvanelslande/vvctre-plugin-quick-settings/releases/download/2.0.0/vvctre-plugin-quick-settings-2.0.0-windows.7z) \| [Download Windows zip](https://github.com/vvanelslande/vvctre-plugin-quick-settings/releases/download/2.0.0/vvctre-plugin-quick-settings-2.0.0-windows.zip) \| [Download Linux 7z](https://github.com/vvanelslande/vvctre-plugin-quick-settings/releases/download/2.0.0/vvctre-plugin-quick-settings-2.0.0-linux.7z) \| [Download Linux zip](https://github.com/vvanelslande/vvctre-plugin-quick-settings/releases/download/2.0.0/vvctre-plugin-quick-settings-2.0.0-linux.zip)
