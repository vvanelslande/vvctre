...
Renderer::Renderer(Frontend::EmuWindow& window) : render_window(window) {
...
void Renderer::DrawSingleScreen(const ScreenInfo& screen_info, float x, float y, float w, float h) {
    const auto& texcoords = screen_info.display_texcoords;
 ...
 * rotation.
 */
void Renderer::DrawSingleScreenStereoRotated(const ScreenInfo& screen_info_l,
...
void Renderer::DrawSingleScreenStereo(const ScreenInfo& screen_info_l,
