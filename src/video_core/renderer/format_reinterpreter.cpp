...
FormatReinterpreter::FormatReinterpreter() {
...
FormatReinterpreter::~FormatReinterpreter() = default;

std::pair<FormatReinterpreter::ReinterpreterMap::iterator,
          FormatReinterpreter::ReinterpreterMap::iterator>
FormatReinterpreter::GetPossibleReinterpretations(PixelFormat dst_format) {
