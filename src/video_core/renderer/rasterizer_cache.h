...
enum class ScaleMatch {
    Exact,   // Only accept same resolution scale
    Upscale, // Only allow higher scale than params
    Ignore   // Accept every scaled resolution
};
...
public:
    ...
    std::unique_ptr<FormatReinterpreter> format_reinterpreter;
};
