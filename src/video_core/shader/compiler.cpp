...
typedef void (Compiler::*Function)(Instruction instr);

const Function instr_table[64] = {
    &Compiler::Compile_ADD,    // add
    &Compiler::Compile_DP3,    // dp3
    &Compiler::Compile_DP4,    // dp4
    &Compiler::Compile_DPH,    // dph
    nullptr,                   // unknown
    &Compiler::Compile_EX2,    // ex2
    &Compiler::Compile_LG2,    // lg2
    nullptr,                   // unknown
    &Compiler::Compile_MUL,    // mul
    &Compiler::Compile_SGE,    // sge
    &Compiler::Compile_SLT,    // slt
    &Compiler::Compile_FLR,    // flr
    &Compiler::Compile_MAX,    // max
    &Compiler::Compile_MIN,    // min
    &Compiler::Compile_RCP,    // rcp
    &Compiler::Compile_RSQ,    // rsq
    nullptr,                   // unknown
    nullptr,                   // unknown
    &Compiler::Compile_MOVA,   // mova
    &Compiler::Compile_MOV,    // mov
    nullptr,                   // unknown
    nullptr,                   // unknown
    nullptr,                   // unknown
    nullptr,                   // unknown
    &Compiler::Compile_DPH,    // dphi
    nullptr,                   // unknown
    &Compiler::Compile_SGE,    // sgei
    &Compiler::Compile_SLT,    // slti
    nullptr,                   // unknown
    nullptr,                   // unknown
    nullptr,                   // unknown
    nullptr,                   // unknown
    nullptr,                   // unknown
    &Compiler::Compile_NOP,    // nop
    &Compiler::Compile_END,    // end
    &Compiler::Compile_BREAKC, // breakc
    &Compiler::Compile_CALL,   // call
    &Compiler::Compile_CALLC,  // callc
    &Compiler::Compile_CALLU,  // callu
    &Compiler::Compile_IF,     // ifu
    &Compiler::Compile_IF,     // ifc
    &Compiler::Compile_LOOP,   // loop
    &Compiler::Compile_EMIT,   // emit
    &Compiler::Compile_SETE,   // sete
    &Compiler::Compile_JMP,    // jmpc
    &Compiler::Compile_JMP,    // jmpu
    &Compiler::Compile_CMP,    // cmp
    &Compiler::Compile_CMP,    // cmp
    &Compiler::Compile_MAD,    // madi
    &Compiler::Compile_MAD,    // madi
    &Compiler::Compile_MAD,    // madi
    &Compiler::Compile_MAD,    // madi
    &Compiler::Compile_MAD,    // madi
...
void Compiler::Compile_Assert(bool condition, const char* msg) {
    if (!condition) {
 ...
 */
void Compiler::Compile_SwizzleSrc(Instruction instr, unsigned src_num, SourceRegister src_reg,
                                  Xmm dest) {
    Reg64 src_ptr;
...
void Compiler::Compile_DestEnable(Instruction instr, Xmm src) {
    DestRegister dest;
    unsigned operand_desc_id;
    if (instr.opcode.Value().EffectiveOpCode() == OpCode::Id::MAD ||
        instr.opcode.Value().EffectiveOpCode() == OpCode::Id::MADI) {
...
void Compiler::Compile_SanitizedMul(Xmm src1, Xmm src2, Xmm scratch) {
...
void Compiler::Compile_EvaluateCondition(Instruction instr) {
...
void Compiler::Compile_DP3(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    Compile_SwizzleSrc(instr, 2, instr.common.src2, SRC2);
...
void Compiler::Compile_DP4(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    Compile_SwizzleSrc(instr, 2, instr.common.src2, SRC2);
...
void Compiler::Compile_DPH(Instruction instr) {
...
void Compiler::Compile_EX2(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    call(exp2_subroutine);
    Compile_DestEnable(instr, SRC1);
}

void Compiler::Compile_LG2(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    call(log2_subroutine);
    Compile_DestEnable(instr, SRC1);
}

void Compiler::Compile_MUL(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    Compile_SwizzleSrc(instr, 2, instr.common.src2, SRC2);
    Compile_SanitizedMul(SRC1, SRC2, SCRATCH);
    Compile_DestEnable(instr, SRC1);
...
void Compiler::Compile_SGE(Instruction instr) {
...
void Compiler::Compile_SLT(Instruction instr) {
...
void Compiler::Compile_FLR(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
...
void Compiler::Compile_MAX(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    Compile_SwizzleSrc(instr, 2, instr.common.src2, SRC2);
...
void Compiler::Compile_MIN(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    Compile_SwizzleSrc(instr, 2, instr.common.src2, SRC2);
    // SSE semantics match PICA200 ones: In case of NaN, SRC2 is returned.
    minps(SRC1, SRC2);
...
void Compiler::Compile_MOVA(Instruction instr) {
...
void Compiler::Compile_MOV(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
    Compile_DestEnable(instr, SRC1);
}

void Compiler::Compile_RCP(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
...
void Compiler::Compile_RSQ(Instruction instr) {
    Compile_SwizzleSrc(instr, 1, instr.common.src1, SRC1);
...
void Compiler::Compile_NOP(Instruction instr) {}

void Compiler::Compile_END(Instruction instr) {
...
void Compiler::Compile_BREAKC(Instruction instr) {
...
void Compiler::Compile_CALL(Instruction instr) {
...
void Compiler::Compile_CALLC(Instruction instr) {
    Compile_EvaluateCondition(instr);
    Label b;
    jz(b);
    Compile_CALL(instr);
...
void Compiler::Compile_CALLU(Instruction instr) {
...
void Compiler::Compile_CMP(Instruction instr) {
...
void Compiler::Compile_MAD(Instruction instr) {
...
void Compiler::Compile_IF(Instruction instr) {
...
void Compiler::Compile_LOOP(Instruction instr) {
    Compile_Assert(instr.flow_control.dest_offset >= program_counter,
...
void Compiler::Compile_JMP(Instruction instr) {
...
void Compiler::Compile_EMIT(Instruction instr) {
...
void Compiler::Compile_SETE(Instruction instr) {
    Label have_emitter, end;
    mov(rax, qword[STATE + offsetof(UnitState, emitter_ptr)]);
    test(rax, rax);
    jnz(have_emitter);
...
void Compiler::Compile_Block(unsigned end) {
...
void Compiler::Compile_NextInstr() {
...
void Compiler::FindReturnOffsets() {
...
void Compiler::Compile(const std::array<u32, MAX_PROGRAM_CODE_LENGTH>* program_code_,
...
Compiler::Compiler() : Xbyak::CodeGenerator(MAX_SHADER_SIZE) {
    CompilePrelude();
}
...
Xbyak::Label Compiler::CompilePrelude_Log2() {
...
Xbyak::Label Compiler::CompilePrelude_Exp2() {
    Xbyak::Label subroutine;
