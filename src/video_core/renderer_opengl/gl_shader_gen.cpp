...
static void AppendColorCombiner(std::string& out, TevStageConfig::Operation operation,
    ...
    case Operation::Modulate:
        out += fmt::format("{}[0] * {}[1]", variable_name, variable_name);
        break;
    case Operation::Add:
        out += fmt::format("{}[0] + {}[1]", variable_name, variable_name);
        break;
    case Operation::AddSigned:
        out += fmt::format("{}[0] + {}[1] - vec3(0.5)", variable_name, variable_name);
        break;
    case Operation::Lerp:
        out += fmt::format("{}[0] * {}[2] + {}[1] * (vec3(1.0) - {}[2])", variable_name,
    ...
    case Operation::MultiplyThenAdd:
        out += fmt::format("{}[0] * {}[1] + {}[2]", variable_name, variable_name, variable_name);
        break;
    case Operation::AddThenMultiply:
        out += fmt::format("min({}[0] + {}[1], vec3(1.0)) * {}[2]", variable_name, variable_name,
                           variable_name);
        break;
    case Operation::Dot3_RGB:
    case Operation::Dot3_RGBA:
        out += fmt::format("vec3(dot({}[0] - vec3(0.5), {}[1] - vec3(0.5)) * 4.0)", variable_name,
                           variable_name);
        break;
    default:
        out += "vec3(0.0)";
...
static void AppendAlphaCombiner(std::string& out, TevStageConfig::Operation operation,
    ...
    case Operation::Add:
        ...
        break;
    case Operation::AddSigned:
        out += fmt::format("{}[0] + {}[1] - 0.5", variable_name, variable_name);
        break;
    case Operation::Lerp:
        out += fmt::format("{}[0] * {}[2] + {}[1] * (1.0 - {}[2])", variable_name, variable_name,
    ...
    case Operation::MultiplyThenAdd:
        ...
        break;
    case Operation::AddThenMultiply:
        out += fmt::format("min({}[0] + {}[1], 1.0) * {}[2]", variable_name, variable_name,
                           variable_name);
        break;
    default:
        out += "0.0";
